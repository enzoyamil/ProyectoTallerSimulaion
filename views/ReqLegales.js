        ...
        <NativeBaseProvider>
            <ScrollView>
                <Stack
                    ...
                    <Center><Text fontSize="20" bold>Capital Inversión</Text></Center>
                    ...
                    <Box rounded="xl" p="5" borderWidth="1">
                        <Stack space={3}>
                            ...
                            <Text>TOTAL:</Text>
                            <Text>Total aporte propio: {sumaCapitalInvProp}Bs.</Text>
                            <Text>Total inversion: {sumaCapitalInvInv}Bs.</Text>
                        </Stack>
                    </Box>
