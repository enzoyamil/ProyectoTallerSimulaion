...
function DetalleInsumo({ producto_o_servico, unidad_medida, precio_venta, navigation, id }) {
    return (
        <NativeBaseProvider>
            <Box rounded="xl" p="5" borderWidth="1">
                <Stack space={3}>
                    ...
                    <Button colorScheme="primary" onPress={() => navigation.navigate("Hoja-de-Costos4_2", {id})}>Detalles</Button>
                </Stack>
            </Box>
        </NativeBaseProvider>
